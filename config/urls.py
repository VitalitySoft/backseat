...
urlpatterns = [
    ...
    path("rides/<int:ride_id>/status", views.update_ride, name="update_ride"), path("joins/<int:join_id>/status", views.update_join, name="update_join"), path("rider/sharing", views.toggle_sharing, name="toggle_sharing"), path("reports/<int:user_id>", views.report_user, name="report_user"), path("blocks/<int:user_id>", views.block_user, name="block_user"),
    ...
    path("api/auth/me", views.api_me, name="api_me"), path("api/rides", views.api_rides, name="api_rides"),
]
